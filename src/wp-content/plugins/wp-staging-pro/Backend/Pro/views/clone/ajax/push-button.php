...
<a href="#" class="wpstg-push-changes wpstg-merge-clone wpstg-clone-action"
   ...
   title="<?php echo esc_html__("Push and overwrite current production website with this cloned site. Select specific folders and database tables in the next step.", "wp-staging"); ?>">
